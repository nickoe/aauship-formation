...
Lastly is the restoring force matrix, which is the one bringing the vessel back to steady state in pitch and roll. This has been estimated to be as in equation \ref{eq:restore}.
\begin{align}
G = 
\begin{bmatrix}
0 & 0 & 0 & 0 & 0\\
