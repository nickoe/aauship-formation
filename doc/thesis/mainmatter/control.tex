...
The sign-function\todo{I suggest to write ``sign function'' rather
than ``sign-function''. nick}, also known as the signum-function, is an odd
...
\end{cases}
\end{align}
\todo{The extra parentheses seems obsolete here. nick}
\todo{Maybe write derivate equals the result, rather than the
rightarrow. nick}
