...
position is placed in a constant spot, it perturbs the desired
position of the agent until the direction of the steepest decent
changes. This will mean that the agent is out of the local minima and
can continue on the trajectory.
