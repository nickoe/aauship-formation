...
\nomenclature{$p_{i}^n$}{a}
\nomenclature{$p_{i0}^n$}{a}
\nomenclature{$p_{j}^n$}{a}
\nomenclature{$p_{j0}^n$}{a}
\nomenclature{$p_{k}^n$}{a}
\nomenclature{$\mathbf{d}_{i}$}{a}
\nomenclature{$\mathbf{d}_{i0}$}{a}
\nomenclature{$\mathbf{d}_{ij}$}{a}
\nomenclature{$\mathbf{d}_{ki}$}{a}
\nomenclature{$K_{vl}$}{a}
\nomenclature{$K_{ij}$}{a}
\nomenclature{$K_{ca}$}{a}
\nomenclature{$K_{oa}$}{a}
