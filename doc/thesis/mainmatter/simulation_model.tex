...
First the magnetic field direction has to be known for the area where the system operates. There exists models of the magnetic field on the earh, accesible from \citep{geomag}. Using the ``WMM 2010'' model, the declination and inclination has been determined to be $2.167 \arcdeg$ (east), and $70.883 \arcdeg$ (down) respectively. Additionally the field strength is about $50432$ nT.

This defines the magnetic field in the earth frams as:
\begin{align}
...
\begin{align}
a_b = [a_x, a_y, 0]^T + R_n^b (\Theta_{nb}) [0,0,g]^\top
\end{align}
