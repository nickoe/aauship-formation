...
\bottomrule
\end{tabular}
\caption{Decision matrix for the formation strategies. The stategy row from the upper half of the table continues on the lower half, whit the points summed in the last coloumn in the lower half.}
