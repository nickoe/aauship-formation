...
A Potential Field Based Approach to Multi-Robot Manipulation, Formation Control with Configuration Space Constraints, UAV Formation Flight using 3D Potential Field, 
...
Formation Control of Underactuated Surface Vessels using the Null-Space-Based Behavioral Control, Behavioral Control for Multi-Robot Perimeter Patrol: A Finite State Automata Approach, 
