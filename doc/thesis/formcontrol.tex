...
\todo{2. Rekonfigurerbar formation. Rigid vs flexible. 3. Difference between swarming og coordinated. Eft lav en definition.}
...
\begin{figure}[htbp]
	...
	\label{fig:diffforms}
\end{figure}
The rigid formation of the ships may not need to be strictly rigid. Situations where it could be of benefit to change the ship's formation can occur. 
...
drift out of position again. This basically means that there exists a
