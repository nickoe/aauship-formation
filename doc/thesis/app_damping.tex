...
\section{Results}
\todo{Her skal maalinger fra tests ind, og tilnaermelse af kurve fra daempningen.}
...
\subsubsection{Surge test}
\todo{Maalinger af acceleration fra 0 til konstant hastighed + Maaling af deceleration med 0 input fra konstant hastighed + tilnaermelse af aftagende kurve}
\subsubsection{Sway test}
\\todo{Maalinger af acceleration fra 0 til konstant hastighed + Maaling af deceleration med 0 input fra konstant hastighed + tilnaermelse af aftagende kurve}
\subsubsection{Yaw test}
\todo{Maalinger af acceleration fra 0 til konstant vinkel hastighed + Maaling af deceleration med 0 input fra konstant vinkel hastighed + tilnaermelse af aftagende kurve}
