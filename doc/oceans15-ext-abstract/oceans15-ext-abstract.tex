...
%The model and simulation has proved to work when implemented on the
%AAUSHIP which results in a vessel that tracks a predetermined
%trajectory. This makes the basis for the further work of expanding the
%fleet of AAUSHIPS and implement the investigated control strategies
%and ending up with a successful digital mapping of the seabed in the
%Limfjord.
