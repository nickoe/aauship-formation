...
\begin{frame}{Modelling}{Estimation with standard GPS}
  \begin{figure}
    {\tiny \includesvg[width=\textwidth]{intermediate-sensor-calculations-block}}
	  \caption{\scriptsize Block diagram of the combined AHRS and KF estimator. Implemented with standard GPS.}
  \end{figure}
\end{frame}

\begin{frame}{Modelling}{Estimation with RTK GPS}
  \begin{figure}
    {\tiny \includesvg[width=\textwidth]{intermediate-sensor-calculations-block}}
    \caption{\scriptsize Block diagram of the combined AHRS and KF estimator. Implemented with RTK GPS.}
  \end{figure}
\end{frame}
...
Nogle af algoritmerne fra vores simuleringer. F.eks vores potentiale check eller vores hastighedscontroller
\end{frame}

\begin{frame}{Potential field}{Validation and error plots}
Valideringsplots / error plots
\end{frame}

\begin{frame}{Potential field}{Performance dependencies}
High res pot check vs low res
\end{frame}

\begin{frame}{Potential field}{Performance dependencies}
High res track vs low res
\end{frame}
...
\item Include disturbances in model
