...
\begin{itemize}
  ...
  \item<3-> Developed in Rhinoceros using lofting techniques.
  \item<4-> Printed on a 3D printer.
  \item<5-> Examined and the process iterated.
  \item<6-> Vacuumformed by DD-plast in Randers and assembled in the machine shop at Aalborg University.
\end{itemize}
...
\begin{itemize}
  ...
  \item Optionally extend the KF with the second GPS and use dilation of precision to modify the observational covariance matrix
