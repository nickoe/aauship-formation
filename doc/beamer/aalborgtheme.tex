...
\begin{frame}{System Design}{Modelling}
<Describe what should be modelled, why 5DOF, parmeter estimation...>
\end{frame}

\begin{frame}{System Design}{Estimaiton}

\end{frame}

\begin{frame}{System Design}{Simulation}

\end{frame}

\begin{frame}{System Design}{Implementation with ROS}
...
%%%%%%%%%%%%%%%%
\section{Schedule}
\begin{frame}{Schedule}{1st Half Goals}
