...
The three chosen strategies are:
\begin{enumerate}
...
\begin{frame}{Potential field}{Limited communication}

\end{frame}

\begin{frame}{Potential field}{Full communication}

\end{frame}

\begin{frame}{Conclusion}{Status now}
\begin{itemize}
  \item Full model of vessel
  \item Analysed and selected strategies
